...
export class NewApplicationService {
  ...
  changeStatus(id:number){
    return this.http.put(this.baseUrl + '/applications/changeStatus', id)
  }

  rejectApplication(application:NewApplication[]){
    return this.http.put(this.baseUrl + '/applications/RejectApplication', application)
  }
